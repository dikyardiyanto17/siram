...
const full_name_element = document.getElementById("full_name_detail")
const nik_element = document.getElementById("nik_detail")
const nrp_element = document.getElementById("nrp_detail")
const participant_id_element = document.getElementById("participant_id_detail")
const role_element = document.getElementById("role_detail")
...
const closeDetail = document.getElementById("close-detail-modal-button")
const closeDetailModal = async () => {
	try {
		...
		console.log("- Error Closing Detail Modal : ", error)
	}
}
...
closeDetail.addEventListener("click", () => {
	try {
		...
		console.log("- Error Closing Modal Detail : ", error)
	}
})
blocker.addEventListener("click", () => {
	try {
		...
		console.log("- Error Closing Blocker : ", error)
	}
})
...
const showDetail = async (e) => {
	try {
		...
		participant_id_element.innerHTML = participant.participant_id
		role_element.innerHTML = participant.role
		...
		console.log("- Error Display Detail : ", error)
	}
}
